...
var commandClass = map[string]string{
	...
	"jc alerts list":        ClassReadOnly,
	"jc alerts get":         ClassReadOnly,
	"jc alerts stats":       ClassReadOnly,
	"jc alerts occurrences": ClassReadOnly,
	"jc alerts notes":       ClassReadOnly,
	...
	"jc alerts rules stats":          ClassReadOnly,
	"jc alerts rules templates list": ClassReadOnly,
	"jc alerts rules templates get":  ClassReadOnly,
	"jc alerts rules status":         ClassMutating,
	"jc alerts rules create":         ClassMutating,
	"jc alerts rules update":         ClassMutating,
	"jc alerts rules delete":         ClassDestructive,
	...
	// Google EMM is read-only by construction: the writes are held back.
	"jc google-emm devices get":                   ClassReadOnly,
	"jc google-emm devices list":                  ClassReadOnly,
	"jc google-emm devices policy-results":        ClassReadOnly,
	"jc google-emm enrollment-tokens get":         ClassReadOnly,
	"jc google-emm enrollment-tokens list":        ClassReadOnly,
	"jc google-emm enterprises connection-status": ClassReadOnly,
	"jc google-emm enterprises get":               ClassReadOnly,
	"jc google-emm enterprises list":              ClassReadOnly,
