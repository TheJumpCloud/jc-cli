...
var Resources = map[string]ResourceSchema{
	...
	"assets": {
		...
		APIVersion:    "v2",
		Verbs:         []string{"list", "get", "create", "update", "delete"},
		DefaultFields: []string{"id", "name", "serialNumber", "assetTag", "status"},
		Fields: []FieldDef{
			{Name: "id", Type: "string", Description: "Unique asset identifier"},
			{Name: "name", Type: "string", Description: "Asset name", Required: true},
			{Name: "serialNumber", Type: "string", Description: "Hardware serial number"},
			{Name: "assetTag", Type: "string", Description: "Organization asset tag"},
			{Name: "status", Type: "string", Description: "Asset status (e.g. In Stock, Assigned, In Repair, Retired, Lost)"},
			{Name: "type", Type: "string", Description: "Asset type (e.g. laptop, desktop, mobile, peripheral)"},
			{Name: "systemId", Type: "string", Description: "Linked JumpCloud system ID"},
			{Name: "createdAt", Type: "datetime", Description: "Creation timestamp"},
			{Name: "updatedAt", Type: "datetime", Description: "Last update timestamp"},
		},
		FilterSupport: true,
		SortSupport:   true,
		SortFields:    []string{"name", "serialNumber", "status", "createdAt", "updatedAt"},
		IDField:       "id",
		NameField:     "name",
	},
	"ldap": {
...
func BuildCommandManifest() CommandManifest {
	return CommandManifest{
		...
		Commands: []CommandEntry{
			...
			{
				Path:        "jc assets",
				Description: "Manage JumpCloud hardware assets",
				Subcommands: []string{"list", "get", "create", "update", "delete"},
				Flags: []FlagEntry{
					{Name: "limit", Type: "int", Description: "Maximum number of results (list)"},
					{Name: "sort", Type: "string", Description: "Sort field (list)"},
					{Name: "filter", Type: "string[]", Description: "Filter expressions (list)"},
					{Name: "name", Type: "string", Description: "Asset name (create/update)"},
					{Name: "serial-number", Type: "string", Description: "Hardware serial number (create/update)"},
					{Name: "asset-tag", Type: "string", Description: "Organization asset tag (create/update)"},
					{Name: "status", Type: "string", Description: "Asset status (create/update)"},
					{Name: "type", Type: "string", Description: "Asset type (create/update)"},
					{Name: "system-id", Type: "string", Description: "Linked JumpCloud system ID (create/update)"},
				},
			},
			{
				Path:        "jc ldap",
