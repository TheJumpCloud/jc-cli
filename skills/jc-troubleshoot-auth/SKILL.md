...
```bash
jc auth-policies simulate --user <username> --ip <their-ip> -t
```
...
1. Check auth policy blast radius: `jc auth-policies blast-radius <policy-name> -t`
